    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto w-full">
        <div className="bg-surface rounded-2xl shadow-sm p-8 md:p-12 border border-slate-100 dark:border-slate-800">
          <h1 className="text-3xl md:text-4xl font-bold text-text-main mb-6">{t('legal.cookie_title')}</h1>
          ...
          <div className="space-y-8 text-text-main leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold mb-4 text-primary">{t('legal.cookie_s1_title')}</h2>
              <p className="mb-3">
                {t('legal.cookie_s1_p')}
              </p>
            </section>
            ...
            <section>
              <h2 className="text-xl font-bold mb-4 text-primary">{t('legal.cookie_s2_title')}</h2>
              <p className="mb-3">
                {t('legal.cookie_s2_p')}
              </p>
            </section>
            ...
            <section>
              <h2 className="text-xl font-bold mb-4 text-primary">{t('legal.cookie_s3_title')}</h2>
              <p className="mb-3">
                {t('legal.cookie_s3_p')}
              </p>
            </section>
            ...
            <section>
              <h2 className="text-xl font-bold mb-4 text-primary">{t('legal.cookie_s4_title')}</h2>
              <p>
                {t('legal.cookie_s4_p')}
              </p>
            </section>
